...
public class Mapa {
	...
	public List<PuntoDeInteres> buscaPuntosDeInteresEnSistemaySistemasExternos(String nombre, String servicio) {
		...
		List<PuntoDeInteres> poisSistema = new ArrayList<PuntoDeInteres>(); // Tiene
																			// los
																			// POIs
																			// encontrados
																			// en
																			// el
																			// Sistema
		List<PuntoDeInteres> poisSistemasExternos = new ArrayList<PuntoDeInteres>(); // Tiene
																						// los
																						// POIs
																						// encontrados
																						// en
																						...
																						// Sistema
																						// Externo
		List<PuntoDeInteres> poisEncontrados = new ArrayList<PuntoDeInteres>(); // Tiene
																				// la
																				// union
																				// entre
																				// poisSistema
																				// y
																				// poisSistemasExternos
