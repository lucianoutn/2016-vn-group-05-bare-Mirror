...
//Lucho: implementé esta sola, fijate que las demás son todas iguales cambiando tipos de datos.
//Mañana la sigo, ahora no doy más
public class PersistidorDePOIs extends AbstractPersistenceTest implements WithGlobalEntityManager{
	...
	private List<PuntoDeInteres> POIS =  new ArrayList<PuntoDeInteres>();//la lista de pois a persistir
	...
	public List<PuntoDeInteres> traerPOIS(){
		...
		return entityManager()
				.createQuery("from PuntoDeInteres", PuntoDeInteres.class)
				.getResultList();
	}
	
	public void persistir() {// le pegás aca todas las horas y cuando es el horario se persiste.
